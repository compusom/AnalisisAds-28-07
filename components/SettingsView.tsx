    ...
    return (
        <div className="max-w-2xl mx-auto bg-brand-surface rounded-lg p-8 shadow-lg animate-fade-in">
            ...
            <p className="text-brand-text-secondary mb-6">
                La aplicación necesita una base de datos PostgreSQL para almacenar clientes y cachear los análisis.
                <br/>
                <strong>Importante:</strong> En un entorno de producción, la conexión directa desde el navegador no es segura. Esto es una simulación; la lógica de conexión debería estar en un backend seguro.
            </p>
